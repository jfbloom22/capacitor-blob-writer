(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.capacitorBlobWriter = {}, global.capacitorExports));
    ...
    class BlobWriterWeb extends core.WebPlugin {
        constructor() {
            super({
                name: 'BlobWriter',
                platforms: ['web']
    ...
    const BlobWriter = core.registerPlugin('BlobWriter', {
        web: () => Promise.resolve().then(function () { return index; }).then(m => new m.BlobWriterWeb()),
    });
    async function writeFile(options) {
        try {
            const [{ baseUrl, authToken }, { uri }] = await Promise.all([
    ...
    exports.BlobWriterWeb = BlobWriterWeb;
